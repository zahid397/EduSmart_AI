# ============================================
# EduSmart AI Pro v5.6 — Final Streamlit Build
# ============================================
...
def listen():
    ...
    try:
        ...
        st.warning("⏱️ সময় শেষ, কিছু শোনা যায়নি।")
        return ""
    except Exception as e:
        st.error(f"🎙️ ভয়েস ইনপুট ব্যর্থ: {e}")
        return ""
...
st.sidebar.metric("Math Cache Hits", len(st.session_state))
